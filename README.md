This is a python code package for analyzing Time Domain Thermoreflectance (TDTR) data, based on the analytical in Cahill 2004 (a copy of which is available in the References folder). The math is the same for Frequency Domain Thermoreflectance (FDTR, Schmidt 2009), Steady State Thermoreflectance (SSTR, Braun 2019), and Square Pulse Thermoreflectance (SPTR, Wang 2022). 
